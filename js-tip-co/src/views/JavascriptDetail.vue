<template>
    <div class="javascriptDetail" sticky-container>
        <div
            class="sticky"
            v-sticky
        ...
        <div class="javascriptDetail_top">
            <div class="javascriptDetail_topTitle">What is the JavaScript ternary operator?</div>
            <div class="javascriptDetail_topInfo">
                By
                <span>@loverajoel</span> on Feb 2, 2021
            </div>
        </div>
        <div class="javascriptDetail_content">
            <div class="javascriptDetail_contentData" v-html="htmlText"></div>
        </div>
        <div class="javascriptDetail_book">
            <div class="javascriptDetail_book__content">
                 <div class="javascriptDetail_bookImg">
                    <img src="https://www.jstips.co/assets/images/book.png" width="250" />
                </div>
                <div class="javascriptDetail_bookInfo">
                    <span> MEET THE NEW JSTIPS BOOK</span> <br>
                    <a class="javascriptDetail_bookInfo_title" href="" >The book to ace the JavaScript Interview.</a>
                    <p>
                        A short book with 100 answers designed to boost your knowledge and help you ace the technical interview within a few days.
                    </p>
                    <a class="javascriptDetail_bookInfo_btn" href="" >GET THE BOOK NOW </a>
                    <a class="javascriptDetail_bookInfo_btn2" href="" ><img src="https://www.jstips.co/book/assets/bestseller.png" width="300" /> </a>
                    
                </div>
            </div>
        </div>
        <div class="javascriptDetail_related">
            <RelatedTips />
        </div>
    </div>
</template>
